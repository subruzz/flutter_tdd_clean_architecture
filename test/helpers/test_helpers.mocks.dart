...
// in flutter_tdd/test/helpers/test_helpers.dart.
...
import 'package:flutter_tdd/core/error/failure.dart' as _i7;
import 'package:flutter_tdd/data/datasource/remote_data_source.dart' as _i9;
import 'package:flutter_tdd/data/model/weather_model.dart' as _i3;
import 'package:flutter_tdd/domain/entities/weather.dart' as _i8;
import 'package:flutter_tdd/domain/repository/weather_repository.dart' as _i4;
import 'package:flutter_tdd/domain/usecases/get_current_weather.dart' as _i10;
...
/// A class which mocks [WeatherRemoteDataSouce].
///
/// See the documentation for Mockito's code generation for more information.
class MockWeatherRemoteDataSouce extends _i1.Mock
    implements _i9.WeatherRemoteDataSouce {
  MockWeatherRemoteDataSouce() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<_i3.WeatherModel> getcurrentWeather(String? city) =>
      (super.noSuchMethod(
        Invocation.method(
          #getcurrentWeather,
          [city],
